    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'club_owner':
          ...
          break;
        case 'team_captain':
          result.teamCaptain = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'season_donations':
          ...
          break;
        case 'week_debt':
          result.weekDebt = serializers.deserialize(value,
...
class _$UsersRecord extends UsersRecord {
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UsersRecord')
          ...
          ..add('teamCaptain', teamCaptain)
          ..add('seasonDonations', seasonDonations)
          ..add('weekDebt', weekDebt)
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  bool _clubOwner;
  bool get clubOwner => _$this._clubOwner;
  set clubOwner(bool clubOwner) => _$this._clubOwner = clubOwner;

  bool _teamCaptain;
  bool get teamCaptain => _$this._teamCaptain;
  set teamCaptain(bool teamCaptain) => _$this._teamCaptain = teamCaptain;
  ...
  int _weekDebt;
  int get weekDebt => _$this._weekDebt;
  set weekDebt(int weekDebt) => _$this._weekDebt = weekDebt;
  ...
  UsersRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _teamCaptain = $v.teamCaptain;
      _seasonDonations = $v.seasonDonations;
      _weekDebt = $v.weekDebt;
