...
import 'schema/punts_record.dart';
...
export 'schema/punts_record.dart';
...
/// Functions to query PuntsRecords (as a Stream and as a Future).
Stream<List<PuntsRecord>> queryPuntsRecord({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PuntsRecord.collection,
...
Future<List<PuntsRecord>> queryPuntsRecordOnce({
  Query Function(Query) queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<PuntsRecord>> queryPuntsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
...
Future<FFFirestorePage<DonationsRecord>> queryDonationsRecordPage({
  DocumentReference parent,
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
