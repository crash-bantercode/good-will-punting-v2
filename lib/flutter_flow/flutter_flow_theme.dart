...
class LightModeTheme extends FlutterFlowTheme {
  ...
  Color secondaryColor = const Color(0xFF1B8F4D);
  ...
  Color card = Color(0x86249689);
  Color cardText = Color(0x6F2F3E4E);
  Color trueBlue = Color(0xFF2C91E3);
  Color viridianGreen = Color(0xFF119DA4);
  Color ceruleanFrost = Color(0xFF6D9DC5);
  Color middleBlueGreen = Color(0xFF80DED9);
  Color blizzardBlue = Color(0xFFAEECEF);
  Color notification = Color(0xFFF90404);
  Color primaryBtnText = Color(0xFFFFFFFF);
  Color lineColor = Color(0xFFE0E3E7);
  Color backgroundComponents = Color(0xFF1D2428);
  Color themeRed = Color(0xFFB65050);
